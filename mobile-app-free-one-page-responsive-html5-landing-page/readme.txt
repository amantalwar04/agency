...
Mobile app free one page responsive HTML5 landing page is a well designed mobile landing page web template with a valid HTML5 & CSS3. This template is based on latest Bootstrap framework 3.3 fully responsive web compatible with multi browser and devices. This template can be used for multi-purpose needs like mobile app, landing page, software product display, business, consultancy, agency, personal portfolio, profile, mobile website and start-up company.
